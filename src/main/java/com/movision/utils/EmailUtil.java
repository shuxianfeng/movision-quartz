...
public class EmailUtil {
     ...
     * @return
     */
    public static String buildContent(String title, String content) {
	...
	public static void main(String[] args) {
		...
		String toEmail = "txl88816@126.com";
		StringBuffer sb = new StringBuffer("");
		sb.append("<div style=\"line-height:40px;height:40px\">");
		sb.append("</div>");
		sb.append("<p style=\"padding:0px\"");
		...
		sb.append("\">");
		sb.append(serverIp);
		sb.append("/rest/validateMail?action=validate&vm=abcd</a>");
		...
		// 发送邮件
		EmailUtil.send(toEmail, sb.toString(), "筑慧宝-找回账户密码");
		/*
