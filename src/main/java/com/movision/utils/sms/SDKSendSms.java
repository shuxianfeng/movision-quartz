...
public class SDKSendSms {
    ...
    public static Boolean sendSMS(String mobile, String params, String templateCode){
        ...
        String gateWay = ApplicationPropertiesUtils.getValue("sms_gateway");
    ...
    public static void main(String[] args) throws IOException {
        ...
        SDKSendSms.sendSMS("18652093798",json,ApplicationPropertiesUtils.getValue("course_begin_sms_template_code"));
