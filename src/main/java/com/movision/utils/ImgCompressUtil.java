...
public class ImgCompressUtil {
	 ...
	 *
	 * @param url
	 *            需要压缩的图片url，例如：F:/Download_pic/613.jpg
	 * @param filePath
	 *            压缩后的图片url，例如：E:/test/fileSource/mini613_2.jpg
	 * @param w
	 *            宽
	 * @param h
	 *            高
	...
	public static boolean ImgCompress(String url, String filePath, int w, int h) {
		...
		String name = FileUtils.getPicName(url);
	...
	public static void main(String[] args) {
		String url = "F:/Download_pic/logo.png";
		int w = 270;
		int h = 176;
		// 压缩后的图片路径
		String fullFileName = FileUtils.getPicName(url);
		String fileName = fullFileName.substring(0,fullFileName.indexOf("."));
		String nextFileName = fileName + "_"+ w+"_"+h ;
		System.out.println(nextFileName);
		System.out.println(fullFileName);
		String filePath = url.replace(fullFileName, nextFileName+".png");
		System.out.println(filePath);

//		String filePath = "F:/Download_pic/test.jpg";
		// 压缩
		try {
